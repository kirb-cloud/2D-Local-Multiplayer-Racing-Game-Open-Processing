function Building (x,y,w,h,xv,yv, c1, c2) {
	...
	this.show = function () {
		...
		building1(this.p.x,  this.p.y, this.s.x, this.s.y, this.c1, this.c2);
		
	}
	
	this.move = function () {
		let temp3 = map(this.p.y, windowHeight/3, windowHeight, 0.85, 1.15);
		this.hbp = createVector (this.p.x-this.s.x/2, this.p.y-this.s.y/3);
		this.hbs = createVector (this.s.x*temp3,temp3*this.s.y/3);
